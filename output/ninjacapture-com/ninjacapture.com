<!DOCTYPE html>
<html lang="en">
<!--#set var="product" value="Ninjacapture" -->
<!--#set var="product_name" value="ninjacapture.com" -->
<!--#set var="meta_title" value="Quick &amp; Easy Screen Capture Chrome Extension" -->
<!--#set var="meta_description" value="Grab screenshots, annotate, and share screens easier than ever before with screen capture Chrome extension. Get access to 30+ apps for as low as $7.99 per user." -->
<!--#set var="keyword" value="screen-capture" -->
        ...
        <div class="row align-items-stretch">
                    ...
                    <div class="homepage-hero__background-graphic-wrapper">
                        <div class="clip-path-sec">
                            <video class="homepage-video homepage-hero__background-graphic" id="home-video" height="460" width="100%" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
                              <source src="/images/screen-capture-video.mp4" type="video/mp4">
                           </video>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-5 mt-5 mt-lg-8 order-lg-1">
                <p class=" text-primary mb-0 bluetext">
                    <img class="align-middle mt-n1 mr-1" src="https://cdn.ninjacapture.com/lib/images/infinity.svg" width="22" height="14" alt="infinity icon">
                    <span class="poppins-600"> Like the Fortune 500 </span>
                </p>
                <h1 class="display-2 fnt-mb mb-0 home-heading-text">Capture, Annotate, and Share Screens </h1>
                <p class="lead mb-5 homepage-hero__deck mt-3">Easily share what you’re seeing with teammates and customers by using NinjaCapture&#x27;s tailor-made screenshot capturing features.</p>
                <div class="position-relative">
                    ...
                    <img src="https://cdn.ninjacapture.com/lib/images/as-low-as-img.svg" alt="as low as icon" class="img-fluid d-none d-lg-block as-low-as-img">
                </div>
        ...
        <div class="row justify-content-center lazyload">
            <div class="col-12 col-md-10 col-lg-7 text-center">
                <p class="text-uppercase text-primary poppins-600" style="font-size: 14px;">3 ways
                    <span class="text-primary"> Ninjacapture </span> helps you</p>
        ...
        <div class="align-items-lg-center align-items-start  row">
            <div class="col-12  col-lg-5">
                <div class="text-center text-lg-left">
                    <div class="mb-2">
                        <img src="https://cdn.ninjacapture.com/images/screen-capture-icon.webp" class="img-fluid lazyload" width="48" height="48" alt="screen-capture-icon">
                    </div>
                    <div class="">
            ...
            <div class="col-12 col-lg-6">
                <div class="mb-5 mb-md-0">
                    <img src="https://cdn.ninjacapture.com/images/screen-capture-reasons.webp" alt="screen capture reasons" class="img-fluid lazyload" width="567" height="453">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center lazyload ">
            <div class="col-12 col-md-10 col-lg-8 text-center ">
                ...
                <h6 class="display-4 mb-3 cust-color ">
                    Get more out of <span class="blog-product-name ml-2 ">Ninjacapture</span>
                </h6>
        ...
        <div class="row justify-content-center mb-md-7 ">
            <div class="col-12 col-lg-10 col-xl-8 mx-auto text-center ">
                ...
                <p class="cust-color mb-6 mb-md-8 ">
                    Ninjacapture is included with 30+ apps in Sales, Marketing, Support, Productivity, HR, Development - we have you covered
                </p>
            </div>
        </div>
