<!DOCTYPE html>
<html lang="en">
<!--#set var="product" value="Schedule.ly" -->
<!--#set var="product_name" value="schedule.ly" -->
<!--#set var="meta_title" value="Appointment Scheduling Software | Schedule.ly by 500apps" -->
<!--#set var="meta_description" value="Appointment scheduling software by Schedule.ly that forever changes how you schedule an appointment or meeting. Get access to 30+ apps for as low as $7.99 per user." -->
<!--#set var="keyword" value="appointment-scheduling" -->
        ...
        <div class="row align-items-stretch">
                    ...
                    <div class="homepage-hero__background-graphic-wrapper">
                        <div class="clip-path-sec">
                            <video class="homepage-video homepage-hero__background-graphic" id="home-video" height="460" width="100%" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
                              <source src="/images/appointment-scheduling-video.mp4" type="video/mp4">
                           </video>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-5 mt-5 mt-lg-8 order-lg-1">
                <p class=" text-primary mb-0 bluetext">
                    <img class="align-middle mt-n1 mr-1" src="https://cdn.schedule.ly/lib/images/infinity.svg" width="22" height="14" alt="infinity icon">
                    <span class="poppins-600"> Grow Like The Fortune 500 </span>
                </p>
                <h1 class="display-2 fnt-mb mb-0 home-heading-text">Appointment Scheduling Software </h1>
                <p class="lead mb-5 homepage-hero__deck mt-3">Grow your business and boost efficiency while saving time for you and your clients.</p>
                <div class="position-relative">
                    ...
                    <img src="https://cdn.schedule.ly/lib/images/as-low-as-img.svg" alt="as low as icon" class="img-fluid d-none d-lg-block as-low-as-img">
                </div>
        ...
        <div class="row justify-content-center lazyload">
            <div class="col-12 col-md-10 col-lg-7 text-center">
                <p class="text-uppercase text-primary poppins-600" style="font-size: 14px;">3 ways
                    <span class="text-primary"> Schedule.ly </span> helps you</p>
                <p class="display-3 mb-7 mb-md-7 top-three-heading cust-color">Everything you need to manage appointments with ease</p>
            </div>
        </div>
        <div class="align-items-lg-center align-items-start  row">
            <div class="col-12  col-lg-5">
                <div class="text-center text-lg-left">
                    <div class="mb-2">
                        <img src="https://cdn.schedule.ly/images/appointment-scheduling-icon.webp" class="img-fluid lazyload" width="48" height="48" alt="appointment-scheduling-icon">
                    </div>
                    <div class="">
                        <h2 class="display-3">AI integration</h2>
                        <p class="cust-color font-weight-bold mb-3">Integrated artificial intelligence (AI) features handle automated replies for very quick appointment scheduling.</p>
                    </div>
                </div>
                <hr class="row-hr">
                <div class="text-center text-lg-left">
                    <h3 class="display-5">Effortless scheduling</h3>
                    <p class="cust-color font-weight-bold mb-3">Schedule an appointment according to your availability, with anyone, at any time.</p>
                </div>
                <hr class="row-hr">
                <div class="text-center text-lg-left">
                    <h4 class="display-5">Customizations</h4>
                    <p class="cust-color font-weight-bold mb-0">Full control of event types, one-on-one or group meetings. Seamless integration into your workflow and activity.</p>
                </div>
            </div>
            <div class="col-lg-1 col-xl-1 d-none d-lg-block"> </div>
            <div class="col-12 col-lg-6">
                <div class="mb-5 mb-md-0">
                    <img src="https://cdn.schedule.ly/images/appointment-scheduling-reasons.webp" alt="appointment scheduling reasons" class="img-fluid lazyload" width="567" height="453">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center lazyload ">
            <div class="col-12 col-md-10 col-lg-8 text-center ">
                ...
                <h6 class="display-4 mb-3 cust-color ">
                    Get more out of <span class="blog-product-name ml-2 ">Schedule.ly</span>
                </h6>
        ...
        <div class="row justify-content-center mb-md-7 ">
            <div class="col-12 col-lg-10 col-xl-8 mx-auto text-center ">
                ...
                <p class="cust-color mb-6 mb-md-8 ">
                    Schedule.ly is included with 30+ apps in Sales, Marketing, Support, Productivity, HR, Development - we have you covered
                </p>
            </div>
        </div>
