<!DOCTYPE html>
<html lang="en">
<!--#set var="product" value="Openedornot" -->
<!--#set var="product_name" value="openedornot.com" -->
<!--#set var="meta_title" value="Email Tracking Chrome Extension for Gmail - Opened or Not" -->
<!--#set var="meta_description" value="Email tracking extension by Opened or Not to track emails and get read confirmations. Get access to 30+ apps for as low as $7.99 per user." -->
<!--#set var="keyword" value="email-tracking" -->
        ...
        <div class="row align-items-stretch">
                    ...
                    <div class="homepage-hero__background-graphic-wrapper">
                        <div class="clip-path-sec">
                            <video class="homepage-video homepage-hero__background-graphic" id="home-video" height="460" width="100%" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
                              <source src="/images/email-tracking-video.mp4" type="video/mp4">
                           </video>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-5 mt-5 mt-lg-8 order-lg-1">
                <p class=" text-primary mb-0 bluetext">
                    <img class="align-middle mt-n1 mr-1" src="https://cdn.openedornot.com/lib/images/infinity.svg" width="22" height="14" alt="infinity icon">
                    <span class="poppins-600"> Like The Fortune 500 </span>
                </p>
                <h1 class="display-2 fnt-mb mb-0 home-heading-text">Track And Know When Your Emails Are Opened </h1>
                <p class="lead mb-5 homepage-hero__deck mt-3">Analyze the best time to send emails and get real-time alerts for every activity on your email while browsing with Opened or Not email tracking Chrome extension.</p>
                <div class="position-relative">
                    ...
                    <img src="https://cdn.openedornot.com/lib/images/as-low-as-img.svg" alt="as low as icon" class="img-fluid d-none d-lg-block as-low-as-img">
                </div>
        ...
        <div class="row justify-content-center lazyload">
            <div class="col-12 col-md-10 col-lg-7 text-center">
                <p class="text-uppercase text-primary poppins-600" style="font-size: 14px;">3 ways
                    <span class="text-primary"> Openedornot </span> helps you</p>
                <p class="display-3 mb-7 mb-md-7 top-three-heading cust-color"></p>
            </div>
        </div>
        <div class="align-items-lg-center align-items-start  row">
            <div class="col-12  col-lg-5">
                <div class="text-center text-lg-left">
                    <div class="mb-2">
                        <img src="https://cdn.openedornot.com/images/email-tracking-icon.webp" class="img-fluid lazyload" width="48" height="48" alt="email-tracking-icon">
                    </div>
                    <div class="">
                        <h2 class="display-3"></h2>
                        <p class="cust-color font-weight-bold mb-3"></p>
                    </div>
                </div>
                <hr class="row-hr">
                <div class="text-center text-lg-left">
                ...
                <div class="text-center text-lg-left">
                    ...
                    <p class="cust-color font-weight-bold mb-0"></p>
                </div>
            </div>
            <div class="col-lg-1 col-xl-1 d-none d-lg-block"> </div>
            <div class="col-12 col-lg-6">
                <div class="mb-5 mb-md-0">
                    <img src="https://cdn.openedornot.com/images/email-tracking-reasons.webp" alt="email tracking reasons" class="img-fluid lazyload" width="567" height="453">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center lazyload ">
            <div class="col-12 col-md-10 col-lg-8 text-center ">
                ...
                <h6 class="display-4 mb-3 cust-color ">
                    Get more out of <span class="blog-product-name ml-2 ">Openedornot</span>
                </h6>
        ...
        <div class="row justify-content-center mb-md-7 ">
            <div class="col-12 col-lg-10 col-xl-8 mx-auto text-center ">
                ...
                <p class="cust-color mb-6 mb-md-8 ">
                    Openedornot is included with 30+ apps in Sales, Marketing, Support, Productivity, HR, Development - we have you covered
                </p>
            </div>
        </div>
