...
<!--#set var="meta_title" value="Project Management Software | Projectsly.com by 500apps
" -->
<!--#set var="meta_description" value="Project management software projectsly by 500apps enables teams to centralize project planning and execute successfully. Get access to 30+ apps for as low as $7.99 per user" -->
<!--#set var="keyword" value="project-management" -->
        ...
        <div class="row align-items-stretch">
                    ...
                    <div class="homepage-hero__background-graphic-wrapper">
                        <div class="clip-path-sec">
                            <video class="homepage-video homepage-hero__background-graphic" id="home-video" height="460" width="100%" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
                              <source src="/images/project-management-video.mp4" type="video/mp4">
                           </video>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-5 mt-5 mt-lg-8 order-lg-1">
                <p class=" text-primary mb-0 bluetext">
                    <img class="align-middle mt-n1 mr-1" src="https://cdn.projectsly.com/lib/images/infinity.svg" width="22" height="14" alt="infinity icon">
                    <span class="poppins-600"> Grow Like The Fortune 500 </span>
                </p>
                <h1 class="display-2 fnt-mb mb-0 home-heading-text">Project Management Software </h1>
                <p class="lead mb-5 homepage-hero__deck mt-3">Plan your work well, track it effectively, and collaborate with your team members efficiently like never before.</p>
                <div class="position-relative">
                    ...
                    <img src="https://cdn.projectsly.com/lib/images/as-low-as-img.svg" alt="as low as icon" class="img-fluid d-none d-lg-block as-low-as-img">
                </div>
...
<!--# include virtual="/remote/lib/500apps/trusted-by-1" -->
        ...
        <div class="row justify-content-center lazyload">
            <div class="col-12 col-md-10 col-lg-7 text-center">
                <p class="text-uppercase text-primary poppins-600" style="font-size: 14px;">3 ways
                    <span class="text-primary"> Projectsly </span> helps you</p>
                <p class="display-3 mb-7 mb-md-7 top-three-heading cust-color">Everything you need to streamline project management</p>
            </div>
        </div>
        <div class="align-items-lg-center align-items-start  row">
            <div class="col-12  col-lg-5">
                <div class="text-center text-lg-left">
                    <div class="mb-2">
                        <img src="https://cdn.projectsly.com/images/project-management-icon.webp" class="img-fluid lazyload" width="48" height="48" alt="project-management-icon">
                    </div>
                    <div class="">
                        <h2 class="display-3">Better project planning</h2>
                        <p class="cust-color font-weight-bold mb-3">Streamline your project planning. Plan every aspect of a project from start to finish to accelerate business growth.</p>
                    </div>
                </div>
                <hr class="row-hr">
                <div class="text-center text-lg-left">
                    <h3 class="display-5">Smart team collaboration</h3>
                    <p class="cust-color font-weight-bold mb-3">Keep tabs on who’s doing what and when. Communicate with your team in real-time to keep projects on track.</p>
                </div>
                <hr class="row-hr">
                <div class="text-center text-lg-left">
                    <h4 class="display-5">Actionable analytics</h4>
                    <p class="cust-color font-weight-bold mb-0">Monitor project status, plan sprints and product roadmaps and create custom reports for data-driven decision making.</p>
                </div>
            </div>
            <div class="col-lg-1 col-xl-1 d-none d-lg-block"> </div>
            <div class="col-12 col-lg-6">
                <div class="mb-5 mb-md-0">
                    <img src="https://cdn.projectsly.com/images/project-management-reasons.webp" alt="project management reasons" class="img-fluid lazyload" width="567" height="453">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center lazyload ">
            <div class="col-12 col-md-10 col-lg-8 text-center ">
                ...
                <h6 class="display-4 mb-3 cust-color ">
                    Get more out of <span class="blog-product-name ml-2 ">Projectsly</span>
                </h6>
        ...
        <div class="row justify-content-center mb-md-7 ">
            <div class="col-12 col-lg-10 col-xl-8 mx-auto text-center ">
                ...
                <p class="cust-color mb-6 mb-md-8 ">
                    Projectsly is included with 30+ apps in Sales, Marketing, Support, Productivity, HR, Development - we have you covered
                </p>
            </div>
        </div>
