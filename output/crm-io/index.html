<!DOCTYPE html>
<html lang="en">
<!--#set var="product" value="CRM.io" -->
<!--#set var="product_name" value="crm.io" -->
<!--#set var="meta_title" value="CRM software | CRM.io by 500apps" -->
<!--#set var="meta_description" value="Drive more sales and grow your business faster with the best cloud-based Customer Relationship Management (CRM) software. Get access to 30+ apps for as low as $7.99 per user." -->
<!--#set var="keyword" value="crm-software" -->
        ...
        <div class="row align-items-stretch">
                    ...
                    <div class="homepage-hero__background-graphic-wrapper">
                        <div class="clip-path-sec">
                            <video class="homepage-video homepage-hero__background-graphic" id="home-video" height="460" width="100%" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
                              <source src="/images/crm-software-video.mp4" type="video/mp4">
                           </video>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-5 mt-5 mt-lg-8 order-lg-1">
                <p class=" text-primary mb-0 bluetext">
                    <img class="align-middle mt-n1 mr-1" src="https://cdn.crm.io/lib/images/infinity.svg" width="22" height="14" alt="infinity icon">
                    <span class="poppins-600"> To Build Releationships Like The Fortune 500 </span>
                </p>
                <h1 class="display-2 fnt-mb mb-0 home-heading-text">CRM Software </h1>
                <p class="lead mb-5 homepage-hero__deck mt-3">Supercharge sales with centralized contacts and deals management, account insights, pipeline management, powerful sales automation, and analytics.</p>
                <div class="position-relative">
                    ...
                    <img src="https://cdn.crm.io/lib/images/as-low-as-img.svg" alt="as low as icon" class="img-fluid d-none d-lg-block as-low-as-img">
                </div>
        ...
        <div class="row justify-content-center lazyload">
            <div class="col-12 col-md-10 col-lg-7 text-center">
                <p class="text-uppercase text-primary poppins-600" style="font-size: 14px;">3 ways
                    <span class="text-primary"> CRM.io </span> helps you</p>
                <p class="display-3 mb-7 mb-md-7 top-three-heading cust-color">Everything you need to drive more sales and grow your business</p>
            </div>
        </div>
        <div class="align-items-lg-center align-items-start  row">
            <div class="col-12  col-lg-5">
                <div class="text-center text-lg-left">
                    <div class="mb-2">
                        <img src="https://cdn.crm.io/images/crm-software-icon.webp" class="img-fluid lazyload" width="48" height="48" alt="crm-software-icon">
                    </div>
                    <div class="">
                        <h2 class="display-3">All in One</h2>
                        <p class="cust-color font-weight-bold mb-3">Seamlessly manage all your sales activities in one place to get more leads, win more deals, and grow your business faster.</p>
                    </div>
                </div>
                <hr class="row-hr">
                <div class="text-center text-lg-left">
                    <h3 class="display-5">Powerful Automation</h3>
                    <p class="cust-color font-weight-bold mb-3">Sell more effectively and efficiently by automating sales activities with easy, custom drag-and-drop workflows.</p>
                </div>
                <hr class="row-hr">
                <div class="text-center text-lg-left">
                    <h4 class="display-5">Actionable Analytics</h4>
                    <p class="cust-color font-weight-bold mb-0">Drive more sales and create happy customers with insight into win-loss analysis, sales forecasting, user reports and more.</p>
                </div>
            </div>
            <div class="col-lg-1 col-xl-1 d-none d-lg-block"> </div>
            <div class="col-12 col-lg-6">
                <div class="mb-5 mb-md-0">
                    <img src="https://cdn.crm.io/images/crm-software-reasons.webp" alt="crm software reasons" class="img-fluid lazyload" width="567" height="453">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center lazyload ">
            <div class="col-12 col-md-10 col-lg-8 text-center ">
                ...
                <h6 class="display-4 mb-3 cust-color ">
                    Get more out of <span class="blog-product-name ml-2 ">CRM.io</span>
                </h6>
        ...
        <div class="row justify-content-center mb-md-7 ">
            <div class="col-12 col-lg-10 col-xl-8 mx-auto text-center ">
                ...
                <p class="cust-color mb-6 mb-md-8 ">
                    CRM.io is included with 30+ apps in Sales, Marketing, Support, Productivity, HR, Development - we have you covered
                </p>
            </div>
        </div>
